...
-- Task 14 — Employee Resignation 
-- Employee 105 leaves the company. 
...
-- HR now wants to store employee experience. 
-- Add: 
...
ADD experience DECIMAL(4,1);

DESC employee;

-- Task 16 — Increase Email Size 
-- The company wants to support longer email addresses. 
-- Change: 
-- email VARCHAR(50) 
-- to: 
-- email VARCHAR(150) 
