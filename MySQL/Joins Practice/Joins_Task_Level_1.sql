...
SELECT c.first_name, c.last_name, c.city, o.total_amount
FROM customers c
INNER JOIN orders o ON c.customer_id = o.customer_id;

-- 4. Display customer name, payment method and order date.
SELECT c.first_name, c.last_name, o.payment_method, o.order_date
FROM customers c
INNER JOIN orders o ON c.customer_id = o.customer_id;

-- 5. Display customer email and order status.
SELECT c.email, o.order_status
FROM customers c 
INNER JOIN orders o ON c.customer_id = o.customer_id;

-- 6. Display customer name and shipping city for every order.
SELECT c.first_name, c.last_name, o.shipping_city
FROM customers c 
INNER JOIN orders o ON c.customer_id = o.customer_id;
...
SELECT c.first_name, c.last_name,  o.order_id, o.order_date, o.order_status, o.total_amount, o.payment_method
FROM customers c 
INNER JOIN orders o ON c.customer_id = o.customer_id
...
SELECT c.first_name, c.last_name, o.delivery_date
FROM customers c 
INNER JOIN orders o ON c.customer_id = o.customer_id
WHERE o.order_status = 'Delivered';
...
SELECT order_id, product_id, quantity, item_total
FROM order_items;
